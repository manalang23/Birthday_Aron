...
public class CakeView extends SurfaceView {
    ...
    public static final float candleHeight = 175.0f;
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        for(int x = 1; x <= modelOfCake.candleAmount; x++) {
            drawCandle(canvas, cakeLeft + (cakeWidth/(modelOfCake.candleAmount+1)) * x - candleWidth/2, cakeTop);
        }
